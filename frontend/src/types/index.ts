...
export type AnalystReportDocument = { schema_version: 1; task_id: string; plan_id: string; plan_version: number; provider: string; model: string; generated_at: string; summary: string; overall_status: AnalystOverallStatus; release_recommendation: AnalystReleaseRecommendation; findings: AnalystFinding[]; next_actions: AnalystNextAction[]; limitations: string[]; evidence_coverage: { available_count: number; referenced_count: number; truncated: boolean; notes: string[] } }
