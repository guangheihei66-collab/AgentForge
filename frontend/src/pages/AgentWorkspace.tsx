...
export function AgentWorkspace({ projects, planning, error, onStart, approvals = [], task, detail, report, onRefreshTask, onApprove, onReject, onExecute }: {
  ...
  return <section className="page-stack">
    ...
    {canResume && onExecute && <div className="panel"><div className="panel-title"><h3>Execution</h3><span>Governed execution</span></div><p>The current Plan has an authoritative approval. Resume through the composite approval command if execution has not started.</p><button type="button" className="button button-primary" onClick={() => void onExecute()}>Resume approved execution</button></div>}
